...
final class DecodeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        switch (message.what) {
            case FcPreferences.DECODE:
                decode((byte[]) message.obj, message.arg1, message.arg2);
                break;
            case FcPreferences.QUIT:
                running = false;
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, FcPreferences.DECODE_SUCCESS, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, FcPreferences.DECODE_FAILURE);
                message.sendToTarget();
            }
        }
    }
