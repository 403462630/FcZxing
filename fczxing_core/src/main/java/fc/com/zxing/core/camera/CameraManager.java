...
import fc.com.zxing.core.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            Point screenResolution = configManager.getPreviewResolution();//configManager.getScreenResolution();
    ...
    public synchronized void setPreviewFramingRect(Point previewFramingRect) {
        configManager.setPreviewResolution(previewFramingRect);
    }
    ...
    public void setDisplayOrientation() {
        ...
        Camera.getCameraInfo(OpenCameraInterface.getCameraId(), info);
