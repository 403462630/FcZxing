...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, PreferencesActivity.DECODE_SUCCESS, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, PreferencesActivity.DECODE_FAILURE);
                message.sendToTarget();
            }
        }
    }
